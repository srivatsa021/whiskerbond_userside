...
export const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-900 to-gray-800 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-6 md:mb-0 md:pr-6">
            ...
            <p className="text-base md:text-lg text-gray-300 mb-6">
              {activePet
                ? `Explore premium products, services, and connect with other ${activePet.type.toLowerCase()} lovers in our vibrant community.`
                : "Join our community of passionate pet owners. Find premium products, trusted services, and share your furry friend's journey with fellow animal lovers."}
            </p>
          ...
          <div className="md:w-1/2 relative">
            <div className="rounded-xl overflow-hidden shadow-xl border border-gray-700 animate-float">
              <div className="w-full h-64 md:h-80 lg:h-96">
                <img
                  src={activePet?.avatar || 'https://images.unsplash.com/photo-1450778869180-41d0601e046e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1450&q=80'}
                  alt={activePet ? `${activePet.name} the ${activePet.breed}` : 'Happy dog and cat together'}
                  className={`w-full h-full ${activePet?.fitMode === 'contain' ? 'object-contain' : 'object-cover'}`}
                />
              </div>
            </div>
            ...
            <div className="absolute -bottom-2 -left-2 md:-bottom-4 md:-left-4 bg-gray-800 p-2 md:p-3 rounded-lg shadow-lg border border-gray-700 hidden sm:block">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium text-white text-xs md:text-sm">2,500+ Active Members</span>
              </div>
            </div>
            ...
            <div className="absolute -top-2 -right-2 md:-top-4 md:-right-4 bg-gray-800 p-2 md:p-3 rounded-lg shadow-lg border border-gray-700 hidden sm:block">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-medium text-white text-xs md:text-sm">500+ Products</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div
        className="absolute bottom-5 right-5 w-8 h-8 md:w-16 md:h-16 text-gray-800 opacity-20 hidden lg:block animate-float"
